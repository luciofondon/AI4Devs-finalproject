...
export class VerifyNoOrphanDevices1749599000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    // Verificar pupitres huérfanos
    ...
    // Verificar validadores huérfanos
